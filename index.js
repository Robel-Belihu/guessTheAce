const cardObjectDefinitions = [
  { id: 1, imagePath: "/images/card-king.jpg" },
  { id: 2, imagePath: "/images/card-jack.webp" },
  { id: 3, imagePath: "/images/card-queen.jpg" },
  { id: 4, imagePath: "/images/card-ace.jpg" },
];
const aceId = 4;

const cardBackImgPath = "/images/card-back.jpg";
...
const collapsedGridAreaTemplate = '"1 1" "1 1"';
const cardCollectionCellClass = ".card-position-1";
...
function gameOver() {
  ...
  const gameOverMessage = `Game Over! Your score is - <span class = 'badge'>${score}</span> Wanna try again? Click on the Play Game button and good luck`;
  ...
  function shuffle() {
    ...
    if (shuffleCount == 500) {
      ...
      updateStatusElement(
        ...
        "block",
        primaryColor,
        "Pick a card to guess the Ace of Spades"
      );
    } else {
      shuffleCount++;
    }
